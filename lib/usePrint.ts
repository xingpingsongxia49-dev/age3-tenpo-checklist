 ...
 *
 * 保存されるPDFの名前は document.title から取られる。ただし iOS Safari は、印刷を呼ぶ
 * 直前に title を書き換えても古い名前のまま保存する。そちらの本命は useDocumentTitle
 * （画面を開いた時点でタイトルを合わせておく）で、ここの差し替えは念のための保険。
 * 印刷のあいだだけ差し替え、終わったら元に戻す。
 *
